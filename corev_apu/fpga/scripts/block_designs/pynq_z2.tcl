...
proc create_root_design { parentCell } {
  ...
  set atop_tieoff_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant atop_tieoff_0 ]
  set_property -dict [list \
    CONFIG.CONST_VAL {0} \
  ...
  set cpu_reset_gen25 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset cpu_reset_gen25 ]
...
\
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins axi_uart16550_0/freeze]
